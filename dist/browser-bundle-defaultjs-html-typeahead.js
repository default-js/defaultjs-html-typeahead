...
/* harmony import */ var _src_HTMLTypeaheadElement__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./src/HTMLTypeaheadElement */ "./src/HTMLTypeaheadElement.js");
...
const initSuggestionBox = (input) => {
	...
	(0,_default_js_defaultjs_common_utils_src_PrivateProperty__WEBPACK_IMPORTED_MODULE_3__.privateProperty)(input, PRIVATE_SUGGESTION_BOX, box);
};

const getSuggestionBox = (input) => {
	return (0,_default_js_defaultjs_common_utils_src_PrivateProperty__WEBPACK_IMPORTED_MODULE_3__.privateProperty)(input, PRIVATE_SUGGESTION_BOX);
};
...
const getRequestElement = (selector) => {
	try {
		...
		if (request instanceof _default_js_defaultjs_html_request_src_HTMLRequestElement__WEBPACK_IMPORTED_MODULE_8__["default"]) return request;
	} catch (e) {
		//ignore
	}
...
const executeRequest = async (input, value) => {
	...
	if (request instanceof _default_js_defaultjs_html_request_src_HTMLRequestElement__WEBPACK_IMPORTED_MODULE_8__["default"]) return request.execute(context);
